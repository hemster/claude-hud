...
export interface StdinData {
  ...
  rate_limits?: {
    ...
    // Claude Code 2.1.2xx exposes per-model weekly windows (e.g. Fable) here.
    // resets_at is an ISO string (CC pre-converts), unlike the epoch-seconds
    // resets_at of five_hour/seven_day.
    model_scoped?: Array<{
...
export interface UsageData {
  ...
  modelScoped?: ModelScopedUsage[];  // per-model weekly windows (e.g. Fable)
